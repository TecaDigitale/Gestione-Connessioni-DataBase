...
drop index UIMGGROUP on IMGGROUP;
...
drop index UOCRGROUP01 on OCRGROUP;
...
drop index UIMGGROUP on TBLRELRIS;
...
/* Index: UIMGGROUP                                             */
/*==============================================================*/
create unique index UIMGGROUP on IMGGROUP
(
   SCANNER_MODEL,
   FORMAT_NAME,
   CAPTURE_SOFTWARE,
...
/* Index: UOCRGROUP01                                           */
/*==============================================================*/
create unique index UOCRGROUP01 on OCRGROUP
(
   FORMAT_NAME,
   SOFTWARE_OCR
);
...
/* Index: UIMGGROUP                                             */
/*==============================================================*/
create unique index UIMGGROUP on TBLRELRIS
(
   RELRISIDRARRIVO,
   RELRISIDRPARTENZA,
   RELRISSEQUENZA
...
alter table TMPFILEXML
   add primary key (RISIDR, RIGA, SINGLETREE);
