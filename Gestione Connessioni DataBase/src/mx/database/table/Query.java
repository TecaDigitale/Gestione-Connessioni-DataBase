...
/**
 * Questa classe viene utilizzata per implementare le tabelle in sola lettura o con Join
 * 
 * @author Randazzo
 *
 */
public abstract class Query extends DataSet
{
  ...
  @SuppressWarnings("unchecked")
	public Query(ConnectionPool conn, Map map)
  {
    super(conn, map);
    defFrom();
    defWhere();
   ...
   * @param msp Connessioni con il database
   */
  ...
  /**
   * Questo metodo viene utilizzato per eseguire l'operazione di ripulitura di tutte le variabili
   * 
   */
  ...
  /**
   * Questo metodo viene utilizzato per indicare tutte le condizioni di default per la Form
   *
   */
  protected abstract void defFrom();
  
  /**
   * Questo metodo viene utilizzato per indicare tutte le condizioni di default per la Where
   *
   */
  ...
  /**
   * Questo metodo viene utilizzata per indicare le condizioni di from della select
  ...
  /**
   * Questo metodo viene utilizzato per aggiungere una condizione all form della Select
   * 
   * @param from Condizione da aggiungere
   */
