...
public abstract class QueryNavigator extends Query
{
   ...
   */
  private static Logger log = new Logger(QueryNavigator.class, "mx.database");
  ...
  @SuppressWarnings("unchecked")
	public QueryNavigator(ConnectionPool conn, Map map)
  {
    super(conn, map);
  ...
  /**
   * Questo metodo viene utilizzato per indicare il numero della pagina attualmente visualizzata
   * @param pagAttVisual
   */
