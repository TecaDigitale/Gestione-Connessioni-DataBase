...
public abstract class TableNavigator extends Table {
	 ...
	 */
	private static Logger log = Logger.getLogger(TableNavigator.class);
	 ...
	 */
	public TableNavigator(ConnectionPool conn, Map<Object, Object> map) {
		super(conn, map);
	 ...
	 *            Lista parametri da caricare
	 */
	public TableNavigator(ConnectionPool conn, MsSqlPool msp, Map<Object, Object> map) {
		super(conn, msp, map);
		navigator = new Navigator();
	}
