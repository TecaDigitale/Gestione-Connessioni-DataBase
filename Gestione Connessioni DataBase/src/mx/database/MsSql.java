...
public class MsSql
{
   ...
   */
  private static Logger log = new Logger(MsSql.class, "mx.database");
  ...
  /**
   * Questa variabile statica viene utilizzata per indicare il database Postgres
   * Server
   */
   ...
   * Selezionato, la variabile può assumere i seguenti valori:<BR>
  ...
  @SuppressWarnings("unchecked")
	private Hashtable className = null;
  ...
  /**
   * Questa variabile viene utilizzata per indicare la connessione inizializzata
   * e aperta
   * 
   */
  ...
  /**
   * Questa variabile viene utilizzata per indicare il numero di record trovati
   */
  ...
  /**
   * Questo metodo viene utilizzato per inizializzare la lista delle classi per
   * la connessione al database gestite
   * 
   */
  @SuppressWarnings("unchecked")
	private void initClassName()
  {
    className = new Hashtable();
    className.put(MsSql.MAXDB, "mx.database.connessioni.MaxDb");
    className.put(MsSql.MSSQL, "mx.database.connessioni.MicrosoftSql");
    className.put(MsSql.MSSQL2005, "mx.database.connessioni.MicrosoftSql2005");
    ...
    className.put(MsSql.DBACCESSFILE, "mx.database.connessioni.DbAccessFile");
  }
  ...
  /**
   * Questo metodo statico serve per convetire i campi TimeStamp del database in
   * formato Stringa riportando la data e l'ora in formatoItaliano
   * 
   * @param data
   ...
   * formato Stringa riportando la data e l'ora in formatoItaliano
   * 
   * @param myData Data da convertire
   * @return Restituisce la data e l'ora convertita nel formato italiano
   */
  ...
  /**
   * Questo metodo statico serve per convetire un GregorianCalendar in
   * formato Stringa riportando la data e l'ora in formatoItaliano
   * 
   * @param data
   * @return Restituisce la data e l'ora convertita nel formato italiano
  ...
  /**
   * Questo metodo statico serve per convetire i campi TimeStamp del database in
   * formato Stringa riportando la data in formato Italiano
   * 
   * @param data
  ...
  /**
   * Questo metodo statico serve per convetire i campi TimeStamp del database in
   * formato Stringa riportando la data in formato Inglese
   * 
   * @param data
   * @return Restituisce la data convertita nel formato italiano
   */
  ...
  /**
   * Questo metodo viene utilizzato per verificare la 
   * validità della conenssione
   * 
   * @return
   */
